...
export const SECTIONS = {
    ...
    questions: [
      {
        ...
        invalidValueMessages: [
          'แบบสอบถามคุณลักษณะของ Gen Z นี้ สำหรับผู้ตอบแบบสอบถามที่มีอายุระหว่าง 16-26 ปี ก่อนวันที่ 24 ธันวาคม 2564 เท่านั้น',
          'กรณีท่านเป็นผู้ได้รับรางวัล จะมีการตรวจสอบหลักฐานบัตรประจำตัวประชาชน ชื่อ-นามสกุล และอายุของท่าน',
          'หากท่านมีอายุไม่อยู่ในช่วง 16 – 26 ปี ท่านจะถูกตัดสิทธิ์การได้รับรางวัล',
        ],
        notifyingMessages: [
          'แบบสอบถามนี้มีวัตถุประสงค์ในการสอบถามคุณลักษณะของ Gen Z สำหรับผู้ตอบที่มีอายุระหว่าง 16-26 ปี ก่อนวันที่ 24 ธันวาคม 2564 เท่านั้น',
          'กรณีท่านเป็นผู้ได้รับรางวัล จะมีการตรวจสอบหลักฐานบัตรประจำตัวประชาชน ชื่อ-นามสกุล และอายุของท่าน หากท่านมีอายุไม่อยู่ในช่วง 16 – 26 ปี ท่านจะถูกตัดสิทธิ์การได้รับรางวัล',
        ],
      },
      {
  ...
  [SECTION_KNOWLEDGE_SOURCE_AND_LEARNING_STYLE]: {
    ...
    questions: [
      ...
      },
      {
        ...
        description:
          'เลื่อนตัวเลข ขึ้น-ลง เพื่อเรียงลำดับความสำคัญ โดย 1=ชอบมากที่สุด 6=ชอบน้อยที่สุด',
        options: [
  ...
  [SECTION_GENZ_LIFESTYLE_IN_PRESENT_PART_1]: {
    ...
    questions: [
      ...
      },
      {
        ...
        type: RESPONSE_TYPE_MULTI_CHOICE,
        title:
          'ท่านต้องการสำเร็จการศึกษาจากสถาบันที่มีชื่อเสียงทำให้ท่านเกิดการได้เปรียบในการได้งานที่มีรายได้สูง',
        description: 'โปรดเลือกระดับความคิดเห็นของท่าน',
        options: [
          {title: 'มากที่สุด', weight: 5},
          {title: 'มาก', weight: 4},
  ...
  [SECTION_GENZ_LIFESTYLE_IN_PRESENT_PART_2]: {
    ...
    questions: [
      ...
      {
        title: 'ระบบการรับสมัคร/คัดเลือกเข้าเรียนระดับบัณฑิตศึกษามีความยุ่งยาก',
        showForGroups: ['B'],
        type: RESPONSE_TYPE_MULTI_CHOICE,
        description: 'โปรดเลือกระดับความคิดเห็นของท่าน',
        options: [
      ...
      {
        title: 'การลาศึกษาต่อเต็มเวลา/ติดต่อกันยาวๆ ขณะทำงานไปด้วยนั้นทำได้ยาก',
        showForGroups: ['D'],
        type: RESPONSE_TYPE_MULTI_CHOICE,
        description: 'โปรดเลือกระดับความคิดเห็นของท่าน',
        options: [
    ...
    questions: [
      {
        ...
        type: RESPONSE_TYPE_PRIORITIZATION,
        title:
          'เลื่อนตัวเลข ขึ้น-ลง เพื่อเรียงลำดับความสำคัญ โดย 1=สำคัญมากที่สุด 10=สำคัญน้อยที่สุด',
        description:
    ...
    questions: [
      {
        ...
        description: 'โปรดเลือกระดับความต้องการการเรียนรู้ในมหาวิทยาลัย',
        options: [
          {title: 'มากที่สุด', weight: 5},
          {title: 'มาก', weight: 4},
          {title: 'ปานกลาง', weight: 3},
      ...
      },
      {
        ...
        type: RESPONSE_TYPE_MULTI_CHOICE,
        title:
          'มหาวิทยาลัยมีหลักสูตรที่ให้ความยืดหยุ่นด้านเวลาที่ใช้ในการศึกษา เช่น หลักสูตรปริญญาที่ไม่กำหนดระยะเวลาในการศึกษา',
        description: 'โปรดเลือกระดับความต้องการการเรียนรู้ในมหาวิทยาลัย',
        options: [
          {title: 'มากที่สุด', weight: 5},
          {title: 'มาก', weight: 4},
      ...
      },
      {
        ...
        type: RESPONSE_TYPE_MULTI_CHOICE,
        title:
          'มหาวิทยาลัยมีหลักสูตรที่ออกแบบตามระดับความรู้ของผู้เรียน (ระดับ beginner intermediate advance)',
        description: 'โปรดเลือกระดับความต้องการการเรียนรู้ในมหาวิทยาลัย',
        options: [
          {title: 'มากที่สุด', weight: 5},
          {title: 'มาก', weight: 4},
  ...
  [SECTION_FEEDBACK]: {
    id: 7,
    title:
      'กรุณาให้ข้อเสนอแนะในมุมมองด้านความสำคัญของมหาวิทยาลัยต่ออนาคตของท่าน',
    questions: [
      {
